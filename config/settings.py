...
class ConfigManager:
    ...
    def _get_env_config(self) -> Dict[str, Any]:
        ...
        env_mappings = {
            ...
            # Environmental factors
            "ECO_EMISSION_FACTOR": ("environmental.emission_factor_kg_co2_per_kwh", float),
            "ECO_TREE_SEQUESTRATION": ("environmental.tree_sequestration_kg_co2_per_year", float),
    ...
    def _dict_to_config(self, config_data: Dict[str, Any]) -> AppConfig:
        ...
        environmental = EnvironmentalFactors(
            emission_factor_kg_co2_per_kwh=env_data.get("emission_factor_kg_co2_per_kwh", 0.0817),
            tree_sequestration_kg_co2_per_year=env_data.get("tree_sequestration_kg_co2_per_year", 22.0),
            energy_tariff_brl_per_kwh=env_data.get("energy_tariff_brl_per_kwh", 0.60),
            efficiency_potential_percent=env_data.get("efficiency_potential_percent", 15.0)
        )
        ...
        return AppConfig(
            ...
            data_source_type=DataSourceType(config_data.get("data_source_type", "synthetic")),
            ...
            dashboard_title=config_data.get("dashboard_title", "EcoTI Dashboard - Sustentabilidade Digital")
        )
