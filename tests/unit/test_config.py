...
try:
    from config.settings import ConfigManager, AppConfig, Environment, DataSourceType, EnvironmentalFactors
...
class TestConfigManager(unittest.TestCase):
    ...
    def test_save_configuration(self):
        ...
        config = AppConfig(
            ...
            environmental=EnvironmentalFactors(
                emission_factor_kg_co2_per_kwh=0.09,
                energy_tariff_brl_per_kwh=0.70
            )
        )
        ...
        self.assertEqual(saved_data['environmental']['emission_factor_kg_co2_per_kwh'], 0.09)
    ...
    def test_partial_config_file(self):
        ...
        self.assertEqual(config.environmental.emission_factor_kg_co2_per_kwh, 0.1)  # From file
        self.assertEqual(config.environmental.tree_sequestration_kg_co2_per_year, 22.0)  # Default
