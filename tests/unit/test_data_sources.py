...
class TestMetricsCalculator(unittest.TestCase):
    ...
    def test_custom_values(self):
        ...
        calculator = MetricsCalculator(
            emission_factor=0.100, tree_sequestration=25.0, energy_tariff=0.75
        )
...
class TestSyntheticDataSource(unittest.TestCase):
    ...
    def test_initial_state(self):
        ...
        assert (
            len(self.data_source.devices) == 5476
        )  # 5376 workstations + 90 HP + 10 VxRail
...
class TestDataValidation(unittest.TestCase):
    ...
    def test_department_distribution(self):
        ...
        data_source = SyntheticDataSource()
        workstations = [
            d for d in data_source.devices if d.device_type == "workstation"
        ]
